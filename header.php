    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 justify-content-between">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <div class="p-3 d-flex ">
                            ...
                            <a class="nav-link active" aria-current="page"  href="galeria.php">Proyectos</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <div class="p-3 d-flex ">
                            ...
                            <a class="nav-link active" aria-current="page"  href="estudios.php">Estudios</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <div class="p-3 d-flex ">
                            ...
                            <a class="nav-link active" aria-current="page"  href="trabajos.php">Trabajos</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <div class="p-3 d-flex ">
                            ...
                            <a class="nav-link active" aria-current="page"  href="tecnologias.php">Tecnologias</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <div class="p-3 d-flex ">
